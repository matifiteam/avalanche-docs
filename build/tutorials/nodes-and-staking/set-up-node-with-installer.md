# Run an Avalanche Node using the Install Script用Install Script运行一个Avalanche节点
...
### Environment considerations环境考虑
...
## Using a previous version使用之前的版本
...
## Reinstall and script update重新安装并更新脚本
