# Integrate an Exchange with Avalanche C-Chain用AVA C链集成一个交易所
...
## Integration using EVM Endpoints使用EVM端点进行集成

### Running an Avalanche node运行AVAX节点
...
### Configuring an Avalanche node配置Avalanche节点
...
### Interacting with the C-Chain与c链相互作用
...
## Ingesting On-Chain Data摄取链上的数据
